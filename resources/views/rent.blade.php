...
@section('content')
    ...
    <div class="container my-4">
        <!-- Header with Title and Process Request Button -->
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            <h2 style="font-size: 1.5rem;">Facility Maestro</h2>
            <button class="btn mt-2 mt-md-0" style="background-color: #70F293; border-color: #70F293; border-radius: 20px; padding: 8px 16px; font-size: 0.9rem;">
                Process Request
            </button>
        </div>

        <!-- Search and Filter Bar -->
        <div class="d-block d-md-flex align-items-center mb-3" style="max-width: 100%; margin: 0 auto; background-color: white; border-radius: 50px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 8px;">
            <!-- Filter Button -->
