        ...
        <ul class="navbar-nav">
            ...
            <li>
                <x-side-nav-links href="/admin/item"
                                  :active="request()->is('admin/item') || request()->is('admin/item/add') ||  request()->is('admin/item/edit/*')">
            ...
            <li>
                <x-side-nav-links href="/admin/storage"
                                  :active="request()->is('admin/storage') || request()->is('admin/storage/add') || request()->is('admin/storage/edit/*')">
