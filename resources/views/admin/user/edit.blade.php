...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form method="POST" action="{{ url('admin/user/edit/'. $data['detail']->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="text-uppercase font-weight-bolder text-sm">Profile</p>
                                <button id="submit" name="submit" type="submit" class="btn btn-primary btn-sm ms-auto">Save</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="txt_username" id="txt_username" class="form-control" type="text" value="{{ $data['detail']->username }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Email address</label>
                                        <input name="txt_email" id="txt_email" class="form-control" type="email" value="{{ $data['detail']->email }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Full Name</label>
                                        <input name="txt_name" id="txt_name" class="form-control" type="text" value="{{ $data['detail']->name }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Phone Number</label>
                                        <input name="txt_phonenumber" id="txt_phonenumber" class="form-control" type="text"
